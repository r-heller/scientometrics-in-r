...
subtitle: "The Leiden Manifesto, DORA, and the Dangers of Indicator Misuse"
author: "Raban Heller"
date: last-modified
abstract: |
  Quantitative indicators can inform research evaluation — but only when used
  responsibly. This chapter presents the two most influential frameworks for
  responsible metrics: the Leiden Manifesto and the San Francisco Declaration
  on Research Assessment (DORA). We examine how metrics can be gamed through
  self-citation cartels, citation stacking, and salami slicing, and we
  discuss the systemic consequences of "publish or perish" culture. A worked
  example demonstrates how self-citation rates vary across researchers using
  OpenAlex data.
keywords: [scientometrics, ethics, leiden-manifesto, dora, responsible-metrics, gaming]
---

## Learning objectives {#sec-ethics-objectives}
...
## Conceptual background {#sec-ethics-background}
...
## Worked example {#sec-ethics-example}
...
```{r}
#| label: fig-ethics-self-citation
...
```{r}
#| label: fig-ethics-self-cite-bar
...
## Diagnostics and interpretation {#sec-ethics-diagnostics}
...
## Limitations and responsible use {#sec-ethics-limitations}
...
- **The Leiden Manifesto applies here too.** Every principle in @sec-ethics-background applies to *our own* analysis. We must be transparent about methods, allow those evaluated to verify data, and avoid false precision [@hicks2015].
:::

## Common pitfalls {#sec-ethics-pitfalls}
...
## Exercises {#sec-ethics-exercises}
...
## Further reading {#sec-ethics-reading}
...
## Session info {#sec-ethics-sessioninfo}
