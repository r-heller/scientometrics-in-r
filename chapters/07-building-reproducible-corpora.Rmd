...
## Learning objectives {#corpora-objectives}
...
## Conceptual background {#corpora-background}
...
## Worked example {#corpora-example}

### Fetching raw data

```{r}
#| label: 07-fetch-corpus-data
#| cache: true
works <- oa_fetch(
  entity = "works",
...
```{r}
#| label: 07-fig-corpora-institutions
...
## Diagnostics and interpretation {#corpora-diagnostics}
...
## Limitations and responsible use {#corpora-limitations}
...
## Common pitfalls {#corpora-pitfalls}
...
## Further reading {#corpora-reading}
...
## Session info {#corpora-sessioninfo}

```{r}
#| label: 07-session-info
sessionInfo()
```
