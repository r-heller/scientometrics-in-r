...
## Learning objectives {#coauth-objectives}
...
## Conceptual background {#coauth-background}
...
```{r}
#| label: 15-fig-coauth-degree-dist
...
## Diagnostics and interpretation {#coauth-diagnostics}
...
## Limitations and responsible use {#coauth-limitations}
...
## Common pitfalls {#coauth-pitfalls}
...
## Further reading {#coauth-reading}
...
## Session info {#coauth-sessioninfo}

```{r}
#| label: 15-session-info
sessionInfo()
```
