...
## Learning objectives {#desc-objectives}
...
## Conceptual background {#desc-background}
...
## Diagnostics and interpretation {#desc-diagnostics}
...
## Limitations and responsible use {#desc-limitations}
...
## Session info {#desc-sessioninfo}

```{r}
#| label: 09-session-info
sessionInfo()
```
