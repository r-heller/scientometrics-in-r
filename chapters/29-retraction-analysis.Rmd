...
## Learning objectives {#retraction-objectives}
...
## Conceptual background {#retraction-background}
...
## Worked example {#retraction-example}

### Finding retracted works

```{r}
#| label: 29-fetch-retraction-data
#| cache: true
retracted <- oa_fetch(
  entity = "works",
  is_retracted = "true",
...
```{r}
#| label: 29-fig-retraction-citations
...
```{r}
#| label: 29-retraction-cite-stats
...
```{r}
#| label: 29-fig-retraction-sources
...
```{r}
#| label: 29-fig-retraction-persistence
...
## Diagnostics and interpretation {#retraction-diagnostics}
...
## Limitations and responsible use {#retraction-limitations}
...
## Common pitfalls {#retraction-pitfalls}
...
## Exercises {#retraction-exercises}
...
## Further reading {#retraction-reading}
...
## Session info {#retraction-sessioninfo}

```{r}
#| label: 29-session-info
sessionInfo()
```
