...
subtitle: "Citation Windows, Half-Lives, and Aging Curves"
author: "Raban Heller"
date: last-modified
abstract: |
  This chapter examines how citation patterns evolve over time. We cover
  citation windows, the citation half-life, aging curves, the Price index,
  and time-series analysis of publication and citation trends. A worked
  example constructs aging curves from OpenAlex data and computes
  half-life estimates for different journals.
keywords: [scientometrics, citation-aging, half-life, price-index, temporal-analysis, citation-window]
---

## Learning objectives {#sec-temporal-objectives}
...
## Conceptual background {#sec-temporal-background}
...
## Worked example {#sec-temporal-example}
...
## Diagnostics and interpretation {#sec-temporal-diagnostics}
...
## Limitations and responsible use {#sec-temporal-limitations}
...
## Common pitfalls {#sec-temporal-pitfalls}
...
## Exercises {#sec-temporal-exercises}
...
## Further reading {#sec-temporal-reading}
...
## Session info {#sec-temporal-sessioninfo}
