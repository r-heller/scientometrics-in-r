...
subtitle: "BibTeX, RIS, WoS Plain Text, and Scopus CSV"
author: "Raban Heller"
date: last-modified
abstract: |
  Bibliographic databases export data in diverse formats. This chapter
  shows how to parse BibTeX, RIS, Web of Science plain text, and Scopus
  CSV files in R, standardize field names, and convert records into a
  tidy tibble ready for analysis.
keywords: [data-acquisition, bibtex, ris, parsing, bibliometrix, import]
---

## Learning objectives {#sec-parsing-objectives}
...
## Conceptual background {#sec-parsing-background}
...
## Worked example {#sec-parsing-example}
...
## Diagnostics and interpretation {#sec-parsing-diagnostics}
...
## Limitations and responsible use {#sec-parsing-limitations}
...
## Common pitfalls {#sec-parsing-pitfalls}
...
## Exercises {#sec-parsing-exercises}
...
## Further reading {#sec-parsing-reading}
...
## Session info {#sec-parsing-sessioninfo}
