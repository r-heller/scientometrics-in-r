...
subtitle: "Tracing the Science–Technology Interface"
author: "Raban Heller"
date: last-modified
abstract: |
  Patents cite scientific papers, creating a measurable link between
  basic research and technological innovation. This chapter introduces
  patent–paper citation analysis, discusses what these linkages measure,
  and demonstrates how to identify papers cited in patents using
  OpenAlex and open patent data. We examine which fields and journals
  are most frequently cited in patents and discuss interpretation
  challenges.
keywords: [scientometrics, patent-citations, technology-transfer, innovation, science-technology-linkage]
---

## Learning objectives {#sec-patent-objectives}
...
## Conceptual background {#sec-patent-background}
...
## Worked example {#sec-patent-example}
...
#| fig-height: 5
works_patent |>
  filter(cited_by_count >= p90, !is.na(so)) |>
  count(so, sort = TRUE) |>
  head(15) |>
...
## Diagnostics and interpretation {#sec-patent-diagnostics}
...
## Limitations and responsible use {#sec-patent-limitations}
...
## Common pitfalls {#sec-patent-pitfalls}
...
## Exercises {#sec-patent-exercises}
...
## Further reading {#sec-patent-reading}
...
## Session info {#sec-patent-sessioninfo}
