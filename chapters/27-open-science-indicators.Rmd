...
## Learning objectives {#openscience-objectives}
...
## Conceptual background {#openscience-background}
...
## Worked example {#openscience-example}

### OA rates by year

```{r}
#| label: 27-fetch-openscience-data
#| cache: true
works <- oa_fetch(
  entity = "works",
...
```{r}
#| label: 27-fig-openscience-oa-trend
...
```{r}
#| label: 27-fig-openscience-types
...
## Diagnostics and interpretation {#openscience-diagnostics}
...
## Limitations and responsible use {#openscience-limitations}
...
## Common pitfalls {#openscience-pitfalls}
...
## Exercises {#openscience-exercises}
...
## Further reading {#openscience-reading}
...
## Session info {#openscience-sessioninfo}

```{r}
#| label: 27-session-info
sessionInfo()
```
