...
subtitle: "Mapping Topical Structure Through Shared Terminology"
author: "Raban Heller"
date: last-modified
abstract: |
  This chapter covers co-word analysis — mapping the intellectual landscape
  of a field through keywords that co-occur in the same publications. We
  extract author keywords and OpenAlex concepts, build co-occurrence
  matrices, construct keyword networks, and identify topical clusters.
  The worked example maps the topical structure of scientometrics research.
keywords: [scientometrics, co-word-analysis, keyword-cooccurrence, topic-mapping, network-analysis]
---

## Learning objectives {#sec-coword-objectives}
...
## Conceptual background {#sec-coword-background}
...
Co-word analysis complements citation-based methods (@sec-cocit-background). Citation networks reveal intellectual influence; co-word networks reveal thematic content. Combining both provides a more complete picture of a field's structure.

## Worked example {#sec-coword-example}
...
cat(glue("Modularity: {round(modularity(communities), 3)}\n"))
```
...
## Diagnostics and interpretation {#sec-coword-diagnostics}
...
## Limitations and responsible use {#sec-coword-limitations}
...
## Common pitfalls {#sec-coword-pitfalls}
...
## Exercises {#sec-coword-exercises}
...
## Further reading {#sec-coword-reading}
...
## Session info {#sec-coword-sessioninfo}
