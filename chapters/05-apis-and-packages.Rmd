...
## Learning objectives {#apis-objectives}
...
## Conceptual background {#apis-background}
...
```{r}
#| label: 05-fig-apis-publications-per-year
...
## Diagnostics and interpretation {#apis-diagnostics}
...
## Limitations and responsible use {#apis-limitations}
...
## Session info {#apis-sessioninfo}

```{r}
#| label: 05-session-info
sessionInfo()
```
