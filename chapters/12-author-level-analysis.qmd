...
subtitle: "Profiles, Name Variants, and ORCID Integration"
author: "Raban Heller"
date: last-modified
abstract: |
  This chapter addresses the author disambiguation problem and shows how
  to build author profiles from OpenAlex data. We examine OpenAlex's
  author clustering, name-variant handling, and ORCID integration, then
  compute author-level statistics including productivity, citation impact,
  and topical breadth. The worked example constructs and visualises an
  author profile entirely from open data.
keywords: [scientometrics, author-disambiguation, orcid, author-profile, openalex]
---

## Learning objectives {#sec-author-objectives}
...
## Conceptual background {#sec-author-background}
...
## Worked example {#sec-author-example}
...
works_slim <- author_works |>
  select(id, display_name, publication_date, cited_by_count, type, so) |>
...
ggplot(venue_counts, aes(x = n, y = reorder(so, n))) +
...
## Diagnostics and interpretation {#sec-author-diagnostics}
...
## Limitations and responsible use {#sec-author-limitations}
...
## Common pitfalls {#sec-author-pitfalls}
...
## Exercises {#sec-author-exercises}
...
## Further reading {#sec-author-reading}
...
## Session info {#sec-author-sessioninfo}
