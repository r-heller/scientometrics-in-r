...
subtitle: "Measuring and Incentivising Transparent Research Practices"
author: "Raban Heller"
date: last-modified
abstract: |
  Reproducibility is a cornerstone of scientific credibility, yet many
  studies cannot be reproduced. This chapter examines bibliometric
  approaches to measuring reproducibility indicators: open badges for
  data and materials, Research Resource Identifiers (RRIDs) for
  reagents and tools, data availability statements, and code
  availability. We analyse the prevalence of these practices in a
  corpus and discuss their relationship to citation impact and
  research quality.
keywords: [scientometrics, reproducibility, open-badges, rrid, data-availability, research-transparency]
---

## Learning objectives {#sec-repro-objectives}
...
## Conceptual background {#sec-repro-background}
...
## Worked example {#sec-repro-example}
...
## Diagnostics and interpretation {#sec-repro-diagnostics}
...
## Limitations and responsible use {#sec-repro-limitations}
...
## Common pitfalls {#sec-repro-pitfalls}
...
## Further reading {#sec-repro-reading}
...
## Session info {#sec-repro-sessioninfo}
