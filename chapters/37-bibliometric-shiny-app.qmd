...
subtitle: "Interactive Analysis for Non-Technical Users"
author: "Raban Heller"
date: last-modified
abstract: |
  Shiny apps bring bibliometric analysis to non-programmers. This
  chapter builds a complete bibliometric Shiny application with journal
  selection, trend visualisation, citation analysis, and network
  exploration — all driven by OpenAlex data. We cover app architecture,
  reactive programming, and deployment options.
keywords: [scientometrics, shiny, interactive-app, openalex, deployment, reactive]
---

## Learning objectives {#sec-shiny-objectives}
...
## Conceptual background {#sec-shiny-background}
...
## Worked example {#sec-shiny-example}
...
## Diagnostics and interpretation {#sec-shiny-diagnostics}
...
## Limitations and responsible use {#sec-shiny-limitations}
...
## Common pitfalls {#sec-shiny-pitfalls}
...
## Further reading {#sec-shiny-reading}
...
## Session info {#sec-shiny-sessioninfo}
