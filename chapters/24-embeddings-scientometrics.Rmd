...
## Learning objectives {#embed-objectives}
...
- **Clustering**: Grouping papers by content in embedding space, complementing topic models (\@ref(topicmodel-background)).
...
## Worked example {#embed-example}

### Preparing text data

```{r}
#| label: 24-fetch-embed-data
#| cache: true
works <- oa_fetch(
  entity = "works",
...
## Diagnostics and interpretation {#embed-diagnostics}
...
## Limitations and responsible use {#embed-limitations}
...
## Common pitfalls {#embed-pitfalls}
...
2. **K-means clustering.** Apply k-means (k = 5, 8, 12) to the document embeddings. Compare the resulting clusters with LDA topics from \@ref(topicmodel-example). Do they agree?
...
## Session info {#embed-sessioninfo}

```{r}
#| label: 24-session-info
sessionInfo()
```
