...
```{r}
#| label: 26-fetch-altmetrics-data
#| cache: true
works <- oa_fetch(
  entity = "works",
...
```{r}
#| label: 26-fig-altmetrics-oa-citations
...
```{r}
#| label: 26-fig-altmetrics-citedist
...
```{r}
#| label: 26-fig-altmetrics-refcount
