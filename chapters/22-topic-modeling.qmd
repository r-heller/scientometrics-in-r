...
subtitle: "LDA, STM, and Structural Topic Models for Bibliometrics"
author: "Raban Heller"
date: last-modified
abstract: |
  Topic models discover latent thematic structure in document collections.
  This chapter introduces Latent Dirichlet Allocation (LDA) and the
  Structural Topic Model (STM), applies them to bibliometric abstracts,
  evaluates model quality with coherence metrics, and interprets topics
  in the context of a research field. The worked example fits both
  models to a scientometrics corpus and compares results.
keywords: [scientometrics, topic-modeling, lda, stm, text-analysis, latent-topics]
---

## Learning objectives {#sec-topicmodel-objectives}
...
## Conceptual background {#sec-topicmodel-background}
...
## Worked example {#sec-topicmodel-example}
...
## Diagnostics and interpretation {#sec-topicmodel-diagnostics}
...
## Limitations and responsible use {#sec-topicmodel-limitations}
...
## Common pitfalls {#sec-topicmodel-pitfalls}
...
## Exercises {#sec-topicmodel-exercises}
...
## Further reading {#sec-topicmodel-reading}
...
## Session info {#sec-topicmodel-sessioninfo}
