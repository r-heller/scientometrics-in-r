...
subtitle: "Quarto Dashboards, plotly, and DT for Bibliometric Exploration"
author: "Raban Heller"
date: last-modified
abstract: |
  Static figures cannot capture the richness of bibliometric data.
  This chapter demonstrates how to build interactive dashboards using
  Quarto's dashboard layout, plotly for interactive charts, and DT
  for searchable data tables. The worked example creates a journal
  analytics dashboard with trend exploration, top-author views,
  and citation distribution interactivity.
keywords: [scientometrics, dashboard, plotly, dt, interactive, quarto]
---

## Learning objectives {#sec-dashboard-objectives}
...
## Conceptual background {#sec-dashboard-background}
...
## Worked example {#sec-dashboard-example}
...
## Diagnostics and interpretation {#sec-dashboard-diagnostics}
...
## Limitations and responsible use {#sec-dashboard-limitations}
...
## Common pitfalls {#sec-dashboard-pitfalls}
...
## Exercises {#sec-dashboard-exercises}
...
## Further reading {#sec-dashboard-reading}
...
## Session info {#sec-dashboard-sessioninfo}
