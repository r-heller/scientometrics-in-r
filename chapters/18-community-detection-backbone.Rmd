...
## Learning objectives {#backbone-objectives}
...
## Conceptual background {#backbone-background}
...
## Worked example {#backbone-example}
...
```{r}
#| label: 18-fig-backbone-resolution
...
## Diagnostics and interpretation {#backbone-diagnostics}
...
## Limitations and responsible use {#backbone-limitations}
...
## Common pitfalls {#backbone-pitfalls}
...
## Further reading {#backbone-reading}
...
## Session info {#backbone-sessioninfo}

```{r}
#| label: 18-session-info
sessionInfo()
```
