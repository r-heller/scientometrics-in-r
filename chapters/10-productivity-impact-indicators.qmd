...
subtitle: "h-index, g-index, MNCS, and PP(top 10%)"
author: "Raban Heller"
date: last-modified
abstract: |
  This chapter covers the most widely used author- and paper-level
  bibliometric indicators. We compute the h-index, g-index, m-quotient,
  Mean Normalized Citation Score, and the proportion of papers in the top
  10% of their field. Every metric is computed from code and accompanied
  by a responsible-use discussion grounded in the Leiden Manifesto.
keywords: [scientometrics, h-index, g-index, mncs, impact, indicators, leiden-manifesto]
---

## Learning objectives {#sec-indicators-objectives}
...
## Conceptual background {#sec-indicators-background}
...
## Worked example {#sec-indicators-example}
...
## Diagnostics and interpretation {#sec-indicators-diagnostics}
...
## Limitations and responsible use {#sec-indicators-limitations}
...
## Common pitfalls {#sec-indicators-pitfalls}
...
## Exercises {#sec-indicators-exercises}
...
## Further reading {#sec-indicators-reading}
...
## Session info {#sec-indicators-sessioninfo}
