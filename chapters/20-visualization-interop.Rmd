...
## Conceptual background {#viz-background}
...
## Diagnostics and interpretation {#viz-diagnostics}
...
## Limitations and responsible use {#viz-limitations}
...
- **Large networks are unreadable.** Beyond ~500 nodes, static network plots become unintelligible. Use interactive visualisation, backbone extraction (\@ref(backbone-example)), or subnetwork extraction for large data.
...
## Session info {#viz-sessioninfo}

```{r}
#| label: 20-session-info
sessionInfo()
```
