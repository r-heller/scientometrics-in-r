...
subtitle: "targets, renv, and Docker for Bibliometric Workflows"
author: "Raban Heller"
date: last-modified
abstract: |
  Bibliometric analyses involve multiple interdependent steps — data
  retrieval, cleaning, analysis, and visualisation — that must be
  reproducible. This chapter introduces pipeline tools for R: targets
  for dependency-aware computation, renv for package management, and
  Docker for environment isolation. The worked example builds a
  minimal targets pipeline for a bibliometric analysis.
keywords: [scientometrics, reproducibility, targets, renv, docker, pipeline]
---

## Learning objectives {#sec-pipeline-objectives}
...
## Conceptual background {#sec-pipeline-background}
...
## Worked example {#sec-pipeline-example}
...
## Diagnostics and interpretation {#sec-pipeline-diagnostics}
...
## Limitations and responsible use {#sec-pipeline-limitations}
...
## Common pitfalls {#sec-pipeline-pitfalls}
...
## Exercises {#sec-pipeline-exercises}
...
## Session info {#sec-pipeline-sessioninfo}
