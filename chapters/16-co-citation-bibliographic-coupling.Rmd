...
## Learning objectives {#cocit-objectives}
...
## Conceptual background {#cocit-background}

While co-authorship networks (\@ref(coauth-background)) reveal social structure, **co-citation** and **bibliographic coupling** networks reveal *intellectual* structure --- the conceptual relationships between documents as expressed through citation behaviour.
...
## Diagnostics and interpretation {#cocit-diagnostics}
...
## Limitations and responsible use {#cocit-limitations}
...
## Common pitfalls {#cocit-pitfalls}
...
## Session info {#cocit-sessioninfo}

```{r}
#| label: 16-session-info
sessionInfo()
```
