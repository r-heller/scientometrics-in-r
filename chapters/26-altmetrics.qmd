---
title: "Altmetrics"
subtitle: "Beyond Citations — Social Media, Policy, and Public Engagement"
author: "Raban Heller"
date: last-modified
abstract: |
  Altmetrics capture dimensions of scholarly impact that citations miss:
  social media attention, news coverage, policy citations, and reader
  counts. This chapter introduces altmetric data sources, retrieves
  altmetric data for an OpenAlex corpus, and evaluates the relationship
  between altmetric indicators and citation counts. We discuss what
  altmetrics measure and what they do not.
keywords: [scientometrics, altmetrics, social-media, mendeley, plumx, scholarly-impact]
---

## Learning objectives {#sec-altmetrics-objectives}
...
## Conceptual background {#sec-altmetrics-background}
...
## Worked example {#sec-altmetrics-example}
...
## Diagnostics and interpretation {#sec-altmetrics-diagnostics}
...
## Limitations and responsible use {#sec-altmetrics-limitations}
...
## Common pitfalls {#sec-altmetrics-pitfalls}
...
## Exercises {#sec-altmetrics-exercises}
...
## Further reading {#sec-altmetrics-reading}
...
## Session info {#sec-altmetrics-sessioninfo}
