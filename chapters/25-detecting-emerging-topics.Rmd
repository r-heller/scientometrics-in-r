...
## Learning objectives {#emerging-objectives}
...
## Conceptual background {#emerging-background}
...
**Temporal topic tracking** extends topic models (\@ref(topicmodel-background)) by fitting models to time-sliced corpora or using dynamic topic models where topic distributions evolve smoothly over time. A simpler approach uses rolling windows: fit a model to each 3-year window and track how topic proportions change between windows.
...
## Worked example {#emerging-example}

### Preparing temporal keyword data

```{r}
#| label: 25-fetch-emerging-data
#| cache: true
works <- oa_fetch(
  entity = "works",
...
```{r}
#| label: 25-build-keyword-timeseries
...
```{r}
#| label: 25-fig-emerging-trajectories
...
## Diagnostics and interpretation {#emerging-diagnostics}
...
## Limitations and responsible use {#emerging-limitations}
...
## Common pitfalls {#emerging-pitfalls}
...
## Further reading {#emerging-reading}
...
## Session info {#emerging-sessioninfo}

```{r}
#| label: 25-session-info
sessionInfo()
```
