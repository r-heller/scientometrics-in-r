...
subtitle: "From Abstracts to Document-Term Matrices"
author: "Raban Heller"
date: last-modified
abstract: |
  This chapter covers text mining techniques for bibliographic corpora.
  We demonstrate how to preprocess titles and abstracts from OpenAlex,
  build document-term matrices with quanteda, compute TF-IDF weights,
  and extract meaningful features from scholarly text. The worked example
  processes a scientometrics corpus and identifies distinctive vocabulary
  across publication years.
keywords: [scientometrics, text-mining, quanteda, tf-idf, document-term-matrix, preprocessing]
---

## Learning objectives {#sec-textmine-objectives}
...
## Conceptual background {#sec-textmine-background}
...
Text mining complements network-based methods (@sec-coword-background). Co-word networks reveal term associations; text mining provides the frequency distributions, temporal trends, and discriminative features that characterise a field's vocabulary.

## Worked example {#sec-textmine-example}
...
## Diagnostics and interpretation {#sec-textmine-diagnostics}
...
## Limitations and responsible use {#sec-textmine-limitations}

::: {.callout-warning}
## Limitations and responsible use

- **Abstracts are summaries.** They capture the main claims but miss nuance, methodology details, and negative results. Full-text analysis (@sec-fulltext-background) provides richer data but is harder to obtain.
...
- **Bag-of-words ignores context.** TF-IDF and frequency-based methods treat documents as unordered collections of words. Phrase meaning ("machine learning" vs. "learning machine") is lost unless you use n-grams or embeddings (@sec-embed-background).
:::

## Common pitfalls {#sec-textmine-pitfalls}
...
## Exercises {#sec-textmine-exercises}
...
## Further reading {#sec-textmine-reading}
...
## Session info {#sec-textmine-sessioninfo}
