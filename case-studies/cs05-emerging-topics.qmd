...
subtitle: "Identifying Research Fronts in Scientometrics"
author: "Raban Heller"
date: last-modified
abstract: |
  This case study applies the emergence detection methods from
  Chapter 25 and the topic modelling techniques from Chapter 22
  to identify emerging research fronts within the scientometrics
  field itself. We combine burst detection, growth-rate analysis,
  and STM topic tracking to paint a picture of where the field
  is heading.
keywords: [case-study, emerging-topics, burst-detection, topic-modeling, research-fronts]
---
