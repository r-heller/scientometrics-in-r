---
title: "Cheatsheets and Quick Reference"
---
...
The `scientometricsInR` package provides three helper functions used throughout the book:
...
| `field_normalize(cites, means)` | MNCS normalisation | `field_normalize(c(20, 5), c(10, 10))` → `c(2.0, 0.5)` |
| `palette_sci(n)` | Viridis colour palette | `palette_sci(4)` |
| `theme_sci()` | Minimal ggplot2 theme | `+ theme_sci()` |
| `fetch_openalex(...)` | Cached OpenAlex queries | `fetch_openalex(entity = "works", ...)` |
